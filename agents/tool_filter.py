...
def build_teammate_tools(
    ...
    from CodeSage.tools.send_message import SendMessageTool
    from CodeSage.tools.task_create import TaskCreateTool
    from CodeSage.tools.task_get import TaskGetTool
    from CodeSage.tools.task_list import TaskListTool
    from CodeSage.tools.task_update import TaskUpdateTool
