...
PROJECT_AGENTS_DIR = ".CodeSage/agents"
USER_AGENTS_DIR = "~/.CodeSage/agents"
...
class AgentLoader:
    ...
    def _load_builtins(self) -> list[AgentDef]:
        results: list[AgentDef] = []
        try:
            builtins_pkg = importlib.resources.files("CodeSage.agents.builtins")
        ...
        for item in builtins_pkg.iterdir():
            ...
            try:
                ...
                from CodeSage.agents.parser import parse_frontmatter, _validate_agent_meta
