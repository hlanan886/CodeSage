...
from codesage.skills.parser import (
    SkillDef,
    SkillParseError,
    parse_frontmatter,
    parse_skill_file,
...
from codesage.skills.executor import (
...
class TestSkillLoader:
    ...
    def test_project_overrides_builtin(self, tmp_path: Path) -> None:
        skills_dir = tmp_path / ".codesage" / "skills"
...
class TestDirectorySkill:
    def test_parse_tool_json(self, tmp_path: Path) -> None:
        from codesage.skills.directory import parse_tool_json
    ...
    def test_register_skill_tools(self, tmp_path: Path) -> None:
        from codesage.skills.directory import register_skill_tools
...
class TestLoadSkillTool:
    ...
    async def test_load_existing_skill(self) -> None:
        from codesage.tools.load_skill import LoadSkill, LoadSkillParams
...
class TestAgentSkillIntegration:
    def test_activate_and_clear(self) -> None:
        ...
        from codesage.prompts import build_environment_context
