...
from codesage.agents.parser import AgentDef, AgentParseError, parse_agent_file, parse_frontmatter
...
from codesage.agents.fork import (
    FORK_BOILERPLATE_TAG,
    ForkError,
    build_forked_messages,
)
from codesage.agents.trace import TraceManager, TraceNode
from codesage.agents.task_manager import BackgroundTask, TaskManager
from codesage.agents.notification import format_task_notification, inject_task_notifications
from codesage.conversation import ConversationManager, Message, ToolResultBlock, ToolUseBlock
...
class TestAgentLoader:
    ...
    def test_project_overrides_builtin(self, tmp_path: Path):
        agents_dir = tmp_path / ".codesage" / "agents"
...
class TestAgentToolParams:
    def test_required_fields(self):
        from codesage.tools.agent_tool import AgentToolParams
