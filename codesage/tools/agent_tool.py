...
if TYPE_CHECKING:
    ...
    from codesage.client import LLMClient
...
class AgentTool(Tool):
    ...
    async def execute(self, params: BaseModel) -> ToolResult:
        ...
        from codesage.agents.fork import ForkError, build_forked_messages
        from codesage.agents.parser import AgentDef
        from codesage.agents.tool_filter import resolve_agent_tools
        from codesage.agent import Agent as AgentClass
        ...
        if p.subagent_type is None:
            from codesage.context import clone_replacement_state
    ...
    async def _execute_as_teammate(self, p: AgentToolParams) -> ToolResult:
        ...
        from codesage.agents.fork import ForkError, build_forked_messages
        from codesage.agents.parser import AgentDef
        from codesage.agents.tool_filter import build_teammate_tools
        from codesage.agent import Agent as AgentClass
        from codesage.conversation import ConversationManager
        from codesage.permissions import (
            DangerousCommandDetector,
        ...
        from codesage.teams.models import BackendType, TeammateInfo
    ...
    def _spawn_pane_teammate(
        ...
        try:
            if backend == BackendType.TMUX:
                from codesage.teams.spawn_tmux import spawn_tmux_teammate
                ...
                from codesage.teams.spawn_iterm2 import spawn_iterm2_teammate
    ...
    async def _execute_with_worktree(self, p: AgentToolParams) -> ToolResult:
        ...
        from codesage.worktree.integration import (
    ...
    def _create_client_for_model(self, model_alias: str) -> LLMClient | None:
        ...
        from codesage.client import create_client
        from codesage.config import ProviderConfig
