...
from codesage.tools.base import Tool
...
def create_default_registry(file_cache: FileCache | None = None, file_history: Any = None) -> ToolRegistry:
    ...
    from codesage.tools.edit_file import EditFile
    from codesage.tools.file_state_cache import FileStateCache
    from codesage.tools.glob import Glob
    from codesage.tools.grep import Grep
