...
from codesage.permissions.dangerous import DangerousCommandDetector, is_safe_command
from codesage.permissions.modes import DecisionEffect, PermissionMode, mode_decide
from codesage.permissions.rules import RuleEngine, extract_content
...
class PermissionChecker:
    ...
    def _is_plan_file(self, target_path: str) -> bool:
        if not self.plan_file_path or not target_path:
            return ".codesage/plans/" in target_path
        try:
