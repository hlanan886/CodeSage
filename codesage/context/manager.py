...
from codesage.serialization import build_messages
...
SESSION_SUBDIR = ".codesage/session/tool-results"
...
async def auto_compact(
    ...
    for attempt in range(max_retries):
        try:
            from codesage.tools.base import StreamEnd, StreamEvent, TextDelta
