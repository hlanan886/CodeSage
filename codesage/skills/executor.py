...
from codesage.skills.parser import SkillDef, substitute_arguments
from codesage.tools import ToolRegistry

if TYPE_CHECKING:
    from codesage.agent import Agent, AgentEvent
...
class SkillExecutor:
    ...
    async def execute_fork(
        ...
        from codesage.agent import Agent as AgentClass, StreamText, LoopComplete, ErrorEvent
