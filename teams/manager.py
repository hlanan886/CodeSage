...
from CodeSage.teams.mailbox import Mailbox, create_message
...
from CodeSage.teams.progress import TeammateProgress
from CodeSage.teams.registry import AgentNameRegistry
from CodeSage.teams.shared_task import SharedTaskStore
from CodeSage.teams.spawn_inprocess import InProcessTeammateHandle
    ...
    def _kill_pane(self, pane_id: str, backend_type: str) -> None:
        try:
            if backend_type == BackendType.TMUX.value:
                from CodeSage.teams.spawn_tmux import kill_pane
                kill_pane(pane_id)
